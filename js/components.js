...
function headerHTML(activePage) {
  ...
  return (
    ...
    '<div class="wrap">' +
    '<a href="index.html" class="logo"><img src="images/logo.png?v=neon7" alt="RIM STUDIO Sandton – alloy wheels, mags and tyres Johannesburg" height="36" /></a>' +
...
function footerHTML() {
  return (
    ...
    "<div>" +
    '<img src="images/logo.png?v=neon7" alt="RIM STUDIO" class="footer-logo" />' +
